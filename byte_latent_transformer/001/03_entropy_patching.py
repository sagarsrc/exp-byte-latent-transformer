...
def visualize_sentence_entropy(
    ...
    """Visualize entropy with combined n-gram models"""
    ...
    plt.title("Combined N-gram (3,4,5) Entropy Analysis")
...
def analyze_and_print_patches(
    ...
    # Visualize
    visualize_sentence_entropy(sentence, ngram_models, threshold)
